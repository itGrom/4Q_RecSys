...
#             self.user_item_matrix = bm25_weight(self.user_item_matrix.T,K1=500, B=0.9).T
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=32, regularization=0.05, iterations=15, num_threads=4):
        """Обучает ALS"""
